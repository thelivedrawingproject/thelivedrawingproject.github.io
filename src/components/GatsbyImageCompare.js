...
class ReactCompareImage extends React.Component {
  ...
  componentDidMount = () => {
    ...
    // Re-set res size when container size is changed
  ...
  componentDidUpdate = (prevProps, prevState) => {
    // do initial setup if loading res and DOM constructing are fully done
    if (
    ...
    // show skeleton again if given res are changed
    if (
